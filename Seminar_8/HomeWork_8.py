...
# from HomeWork_8 import data_create
...
# json_str = data_create.dumps(data)
# print(json_str)

# # Разбор JSON-строки
# data_create = '{"name": "Вадим", "age": 38, "city": "Москва"}'
# parsed_data = data_create.loads(data_create)
...
#     data = data_create.load(file)

# def save_data():
#     # Сохраняем данные обратно в файл
#     with open('"data_first_variant.csv", "a", encoding="utf-8"') as file:
#         data_create.dump(data, file)
